...
export default function HamburgerMenu({
  ...
  return (
    <button
      className={clsx(
        "group fixed top-2 -right-1 md:right-2 z-50 flex flex-col items-end justify-around gap-1 w-[40px] h-[40px] px-2 py-3 -translate-x-3 md:-translate-x-4 lg:hidden",
        {
          "outline-light-theme dark:outline-dark-theme items-center border-2 dark:border-2 border-neutral-200 dark:border-neutral-500 -translate-x-[12px] transition-transform duration-500 md:translate-x-0":
            showMobileNav,
        }
      )}
