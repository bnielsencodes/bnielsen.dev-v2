  ...
  return (
    ...
    >
      <div className="flex flex-col items-start justify-center w-full max-w-[1100px] mx-auto lg:items-center">
        ...
        {/* post title */}
        <h1 className="mt-7 mb-5 text-neutral-100 dark:text-neutral-600 text-[58px] leading-[4.25rem] font-extrabold text-left md:text-7xl lg:text-8xl lg:leading-[1.15] lg:text-center">
