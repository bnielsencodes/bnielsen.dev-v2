    ...
    >
      ...
      <div className="flex items-center justify-start w-full h-full pl-4 md:pl-5">
        {window.location.pathname === "/" ? (
          // PORTFOLIO MOBILE NAVLIST
          <ul className="all-transition flex flex-col justify-between h-[19.5rem] text-neutral-200 dark:text-neutral-500 text-[5rem] md:h-[20.5rem] md:text-[5.5rem]">
            <motion.div
          ...
          >
            ...
            <motion.div
              className={clsx(
                "transition-[margin] flex items-center h-[65px]",
                {
