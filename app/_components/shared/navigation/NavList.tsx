        ...
        <li className="nav-item group">
          {blog ? (
            ...
            >
              ...
              <ul
                className={clsx(
                  "absolute top-[32px] right-0 flex flex-wrap gap-x-4 gap-y-2 w-[150px] p-4 border-2 border-neutral-300 rounded-lg bg-neutral-600 text-[17px] font-medium dark:bg-neutral-300",
                  {
                    block: dropdownOpen,
                    hidden: !dropdownOpen,
                  }
