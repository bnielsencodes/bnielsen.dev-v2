export default function ResumeBtn() {
  return (
    <a
      ...
      href="https://drive.google.com/file/d/1pJRoHl7UbfoqWO87wGbVoFV1ib-B3G5C/view?usp=drive_link"
    ...
    >
      ...
      <p className="font-sans text-[1.125rem] tracking-wide text-neutral-200 group-focus:opacity-90 transition-opacity dark:text-neutral-500 lg:group-hover:opacity-90">
        view my resume
      </p>
    </a>
  );
