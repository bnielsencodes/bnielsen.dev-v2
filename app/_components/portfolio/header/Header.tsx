  ...
  if (resolvedTheme === "dark") {
    return (
      ...
      >
        ...
        {/* header intro */}
        <h1 className="all-transition w-full mb-5 text-neutral-100 text-[11vw] font-extrabold leading-[1.15em] tracking-wide text-left dark:text-neutral-600 md:text-[7.6vw] lg:w-[850px] lg:mt-[1.6rem] lg:text-[4.125rem] lg:leading-[1.1em] lg:text-center xl:w-[985px] xl:text-[76px] xl:font-extrabold xl:leading-[5.35rem]">
