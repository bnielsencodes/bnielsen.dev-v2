  ...
  if (!mounted) {
    return (
      <div className="flex gap-[16.5px] md:pl-[0.5px] lg:w-[250px] lg:pl-[2px] lg:mx-auto xl:pl-[1px]">
        <div className="w-[125px] h-[48px] rounded-lg bg-neutral-400 dark:bg-neutral-500 animate-pulse"></div>
        <div className="w-[102px] h-[48px] rounded-lg bg-neutral-400 dark:bg-neutral-500 animate-pulse"></div>
      </div>
    );
  }
