...
export default function CSS({
  ...
  if (!mounted) {
    return (
      <div
        className={`icon--${skill.name} w-[53px] h-[53px] my-[1px] rounded-lg bg-neutral-200 dark:bg-neutral-500 animate-pulse`}
      ></div>
    );
  }
  ...
  if (resolvedTheme === "dark") {
    return (
      <div className={`icon--${skill.name} w-[55px] h-[55px]`}>
        {/* CSS icon - dark theme */}
        {skill.name === "css" && (
        ...
        {skill.name === "figma" && (
          <svg viewBox="0 0 128 128">
            ...
            ></path>
            <path
              className="fill-transition group-hover:fill-tech-figma-200"
              fill="#ededed"
              stroke="#1a1a1a"
              d="M24 64.5C24 52.6 33.6 43 45.5 43H67v43H45.5C33.6 86 24 76.4 24 64.5zm0 0"
            ></path>
            <path
              className="fill-transition group-hover:fill-tech-figma-300"
              fill="#ededed"
              stroke="#1a1a1a"
              d="M24 21.5C24 9.6 33.6 0 45.5 0H67v43H45.5C33.6 43 24 33.4 24 21.5zm0 0"
            ></path>
            <path
              className="fill-transition group-hover:fill-tech-figma-400"
              fill="#ededed"
              stroke="#1a1a1a"
              d="M67 0h21.5C100.4 0 110 9.6 110 21.5S100.4 43 88.5 43H67zm0 0"
            ></path>
            <path
              className="fill-transition group-hover:fill-tech-figma-500"
              fill="#fafafa"
              stroke="#1a1a1a"
  ...
  if (resolvedTheme === "light") {
    return (
      <div className={`icon--${skill.name} w-[55px] h-[55px]`}>
        ...
        {/* FIGMA icon - light theme */}
        {skill.name === "figma" && (
          <svg className="inline-block dark:hidden" viewBox="0 0 128 128">
            <path
              className="fill-transition group-hover:fill-tech-figma-100"
              fill="#272727"
              stroke="#fafafa"
