...
const termsWithoutId = [
  {
    ...
    seeAlso: [
      { id: 1, term: "Error 400", link: "#error400" },
      { id: 2, term: "Error 401", link: "#error401" },
      { id: 3, term: "Error 403", link: "#error403" },
      { id: 4, term: "Error 404", link: "#error404" },
      { id: 5, term: "Error 500", link: "#error500" },
      { id: 6, term: "Error 502", link: "#error502" },
    ],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
  ...
  },
  {
    ...
    seeAlso: [
      { term: "Accessibility", link: "#accessibility" },
      { term: "WCAG", link: "#wcag" },
    ],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
  ...
  },
  {
    ...
    // link: "https://www.techtarget.com/whatis/definition/abstraction",
    seeAlso: [""],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
    // img: { src: "image", alt: "", width: 0, height: 0 },
  ...
  },
  {
    ...
    // link: "https://www.w3schools.com/w3css/w3css_accordions.asp",
    seeAlso: [""],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
    // img: { src: "image", alt: "", width: 0, height: 0 },
  ...
  },
  {
    ...
    // link: "https://medium.com/@InkDiVo/development-of-a-website-by-agile-methodology-dd6801e7833c",
    seeAlso: [{ term: "Scrum", link: "#scrum" }],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
    // img: { src: "image", alt: "", width: 0, height: 0 },
    // example: { src: "", alt: "" },
  },
  {
    ...
    // link: "https://www.reddit.com/r/explainlikeimfive/comments/1fpdnt/eli5_algorithms",
    seeAlso: [{ term: "Data Structures", link: "#data-structures" }],
    // tags: ["javascript", "css", "etc."],
    examples: [
      "sort algorithms",
      "search algorithms",
  ...
  },
  {
    ...
    // link: "https://www.w3schools.com/whatis/whatis_ajax.asp",
  ...
  },
  {
    ...
    seeAlso: [
      { term: "Fetch API", link: "#fetch-api" },
      { term: "REST API", link: "#rest-api" },
    ],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
    // img: { src: "image", alt: "", width: 0, height: 0 },
  ...
  },
  {
    ...
    seeAlso: [
      { term: "ARIA Attributes", link: "#aria-attributes" },
      { term: "ARIA Roles", link: "#aria-roles" },
    ],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
    // img: { src: "image", alt: "", width: 0, height: 0 },
  ...
  },
  {
    ...
    seeAlso: [
      { term: "Object", link: "#object" },
      {
        term: "Primitive Data Types (JavaScript)",
  ...
  },
  {
    ...
    seeAlso: [
      { term: "Asynchronous", link: "#asynchronous" },
      { term: "Synchronous", link: "#synchronous" },
    ],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
    // img: { src: "image", alt: "", width: 0, height: 0 },
  ...
  },
  {
    ...
    // link: "https://developer.mozilla.org/en-US/docs/Glossary/Asynchronous",
    seeAlso: [
      { term: "Async/Await", link: "#async-await" },
      { term: "Synchronous", link: "#synchronous" },
    ],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
  ...
  },
  {
    ...
    // link: "https://www.lenovo.com/us/en/glossary/attributes",
    seeAlso: [{ term: "Property", link: "#property" }],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
    // img: { src: "image", alt: "", width: 0, height: 0 },
    // example: { src: "", alt: "" },
  },
  {
    ...
    seeAlso: [{ term: "Character Encoding", link: "#character-encoding" }],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
    // img: { src: "image", alt: "", width: 0, height: 0 },
    // example: { src: "", alt: "" },
  ...
  },
  {
    ...
    // link: "https://www.appdirect.com/resources/glossary/b2b-saas",
    // seeAlso: [
    //   { term: "NPM", link: "#npm" },
    // ],
    // tags: ["javascript", "css", "etc."],
  ...
  },
  {
    ...
    // link: "https://stackoverflow.com/questions/2956447/what-is-the-importance-of-backend-in-web-developing",
    seeAlso: [
      { term: "Frontend", link: "#frontend" },
      { term: "Fullstack", link: "#fullstack" },
    ],
    // tags: ["javascript", "css", "etc."],
    // examples: ["exampleOne", "exampleTwo", "etc."],
    // img: { src: "image", alt: "", width: 0, height: 0 },
  ...
  },
  {
    ...
    // link: "https://ahrefs.com/blog/what-are-backlinks",
    // seeAlso: [
    //   { term: "Frontend", link: "#frontend" },
    // ],
    // tags: ["javascript", "css", "etc."],
  ...
  },
  {
    ...
    // link: "https://en.wikipedia.org/wiki/Bounce_rate",
    seeAlso: [
      {
  ...
  },
  {
    ...
    // link: "https://www.smashingmagazine.com/2009/03/breadcrumbs-in-web-design-examples-and-best-practices",
    // seeAlso: [
    //   {
    //     term: "Margin",
    //     link: "#margin",
  ...
  },
  {
    ...
    // link: "https://medium.com/theymakedesign/breakpoints-in-web-design-4e3b334066e8",
    seeAlso: [
      {
        term: "Media Query",
        link: "#media-query",
  ...
  },
  {
    ...
    // link: "https://dev.to/coderjay06/how-to-build-a-carousel-from-scratch-531c",
    // seeAlso: [
    //   {
    //     term: "Kebab Case",
    //     link: "#kebab-case",
  ...
  },
  {
    ...
    idAttribute: "character-encoding",
    definition:
  ...
  },
  {
    ...
    idAttribute: "classes-javascript",
  ...
  },
  {
    ...
    // link: "https://en.wikipedia.org/wiki/Client_(computing)",
    seeAlso: [
      {
  ...
  },
  {
    ...
    idAttribute: "client-side-rendering",
    definition:
  ...
  },
  {
    ...
    // link: "https://developer.mozilla.org/en-US/docs/Glossary/Compile",
    // seeAlso: [
    //   {
    //     term: "Webpack",
    //     link: "#webpack",
