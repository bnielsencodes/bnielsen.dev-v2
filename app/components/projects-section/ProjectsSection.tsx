...
export default function ProjectsSection(props: any) {
  return (
    ...
    >
      <p
        className={clsx(
          "relative z-0 w-[190px] mx-auto mb-[10px] text-[2.5rem] font-bold text-center after:absolute after:content-[''] after:-z-10 after:right-0 after:bottom-[5px] after:w-[145px] after:h-[14px]",
          {
