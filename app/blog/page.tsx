    ...
    return (
      <main className="blog bg-neutral-600">
        ...
        <Image
          ...
          sizes="100vw"
        />
        <div className="home-grid grid gap-y-[64px] w-full pt-[56px] px-5 pb-40 md:items-start md:gap-x-[96px] md:max-w-[1100px] md:px-8 md:mx-auto">
          <RecentlyPublished />
          <TopCategories />
          <PopularContent />
        </div>
    ...
    return (
      <main className="blog dark bg-neutral-100">
        ...
        <Image
          ...
          sizes="100vw"
        />
        <div className="home-grid grid gap-y-[64px] w-full pt-[56px] px-4 pb-40 md:items-start md:gap-x-[96px] md:max-w-[1100px] md:px-8 md:mx-auto">
          <RecentlyPublished />
          <TopCategories />
          <PopularContent />
        </div>
